...
namespace ReadWriteMemory
{
    public class ProcessMemory
    {
        ...
        */
        ...
        public void SendKey(Key c)
        {
            // PostMessage(MyProcess[processIndex].MainWindowHandle, 0x100, ((IntPtr)c), (IntPtr)0);
            PostMessage(MyProcess[processIndex].MainWindowHandle, 0x100, (IntPtr) Util.InputKeyToFormsKeys(c), (IntPtr) 0);
        }
        ...
        public void SendClick(WMessages type)
        {
            ...
            switch(type)
            {
                case WMessages.WM_LBUTTONDOWN:
                    PostMessage(MyProcess[processIndex].MainWindowHandle,
                        (UInt32)WMessages.WM_LBUTTONDOWN, (IntPtr)0x1,
                        (IntPtr)((pos.Y << 16) | (pos.X & 0xFFFF)));
                    return;
                case WMessages.WM_LBUTTONUP:
                    PostMessage(MyProcess[processIndex].MainWindowHandle,
                            (UInt32)WMessages.WM_LBUTTONUP, (IntPtr)0x1, // <--(2) but you are telling to do WM_LBUTTONDOWN
                            (IntPtr)((pos.Y << 16) | (pos.X & 0xFFFF)));
                    return;
                default:
                    return;
        ...
        static extern int PostMessage(IntPtr idHook, uint Msg, IntPtr wParam, IntPtr lParam);
        // Nested Types
        [Flags]
